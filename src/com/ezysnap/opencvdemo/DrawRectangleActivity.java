...
public class DrawRectangleActivity extends Activity {
	...
	button.setOnClickListener(new OnClickListener() {
		...
		byte[] resultByte = mOpenCV.drawRectangle((result.getWidth() - 100) / 2, (result.getHeight() - 100) / 2, (result.getWidth() + 100) / 2, (result.getHeight() + 100) / 2);
